...
describe('src/meta', function() {
    ...
    describe('given a V1 hostname, instance, protocol, port, security token, post and get AJAX methods', () => {
        beforeEach(() => {
        ...
        describe('when creating a meta object', () => {
            beforeEach(() => {
                this.actual = createMeta('h', 'i', 'http', 80, 'token', this.postFn, this.getFn);
            });
...
describe('src/meta.create', function() {
    ...
    describe('given an asset type and asset data', () => {
        describe('when creating an asset', () => {
            ...
            it('it should post the asset creation to the REST URL endpoint', () => {
...
describe('src/metaupdate', function() {
    beforeEach(() => {
        this.actual = undefined;
        this.meta = createMeta('h', 'i', 'http', 80, 'token', () => {
        }, () => {
    ...
    describe('given an asset type and asset data', () => {
        describe('when updating an asset', () => {
            beforeEach(() => {
                ...
                this.meta = createMeta('h', 'i', 'http', 80, 'token', this.postFn, this.getFn);
            ...
            it('it should post the asset update to the REST URL endpoint', () => {
...
describe('src/meta.query', function() {
    ...
    describe('given a valid query object', () => {
        describe('when querying meta', () => {
            ...
            it('it should post the asset update to the query URL endpoint', () => {
